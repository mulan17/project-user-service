...
- Які у нас є ресурси? /my/orders, /orders, /users, /me
- Які операції ці ресурси підтримують? POST /my/orders, GET /users
  
3. Описуємо архітектуру сервісу з точки зору Go
- Які у нас є шари та пакети? Наприклад, rest, database, core
